...
当前功能基线处于 **M1–M93-B1 + W10–W12** 的状态：全局覆盖率 60.03%、CI 覆盖率门禁 60%，
...
未经证实的登录前“实时”数字，M93-B1 完成认证状态联动、粒子生命周期、移动端首屏与 SVG 节点修复，
并以确定性 API fixture 将双视口 Playwright/axe 回归提升到 38/38。post-M45 路线完成 15 个里程碑

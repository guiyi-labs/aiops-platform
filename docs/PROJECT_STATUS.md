...
| 远程同步 | M93-C 交付要求 `main` + `baseline-m93c-tech-console-20260809` 同步并确认 CI 全绿 |
...
- **docs/changes/**：141 份变更记录 + 1 份模板。M21–M93-C 每个里程碑均有独立 `YYYY-MM-DD-mXX-*.md` change-record（M61–M66、M74、M75 已于 2026-08-09 补齐）；M1–M20 早期以主题文档（认证、引导、集群接入等）形式归档。

...
- 提交：`c250ccd11280fdea973a6200e1c388fc23d88eac`
- 改动：在 `site/content/docs/user/working-offline.md` 增加 mirror registry 小节，
  说明从镜像源拉取 `kindest/node`、重新标记为 `kindest/node:<tag>`，以及使用
  digest 固定引用创建集群。
- DCO：提交包含 `Signed-off-by: Guiyi Labs <277616126+guiyi-labs@users.noreply.github.com>`。

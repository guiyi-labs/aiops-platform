...
- [x] **W8/M84 测试强度**：核心包 ≥70% 门禁 + fuzz + benchmark 已落地；全局覆盖率 ≥60%（2026-08-09 实测 60.03%）已达成，CI 门禁同步提升到 60%。
- [x] **W9/M85 前端质量 + 浏览器 E2E**：Playwright 双视口 7 条关键链路全绿、console error=0 已落地（14/14）；a11y 深化与 bundle 体积门禁为后续增量。

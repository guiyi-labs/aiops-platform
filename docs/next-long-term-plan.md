...
**进度**：M100-A 已完成（2026-08-12，`docs/changes/2026-08-12-m100a-permission-matrix-and-aiops-scope.md`）——路由权限矩阵生成器与差异门禁（`docs/security/permission-matrix.md`）、`/aiops` 查询维度集群/命名空间授权强制；M100-B/C/D 待续。

...
if ($null -ne $go) {
    ...
    Write-Host '[2/8] go build server and offline administration commands'
    ...
    Write-Host '[2/8] go build server and offline administration commands (Docker Go toolchain)'
